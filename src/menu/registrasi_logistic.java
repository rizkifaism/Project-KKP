 ...
 */
 public class registrasi_logistic extends javax.swing.JFrame {
    Connection con;
    Statement stm;
    ResultSet rs;
    String sql;
    ...
    jLabel1.setText("Buat Akun Logistic");
    ...
    getContentPane().add(tombol_Daftar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 301, 120, 40));
    ...
    getContentPane().add(tombol_Hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 301, 120, 40));
    ...
    getContentPane().add(tombol_Akun, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 360, -1, 40));
    ...
    private void tombol_DaftarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombol_DaftarActionPerformed
        ...
        try {
            if(!password.equals(password2)) {
                ...
                sql = "insert into user_logistic values('" + username + "','" + password + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registrasi_logistic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registrasi_logistic().setVisible(true);
            }
        });
    }
